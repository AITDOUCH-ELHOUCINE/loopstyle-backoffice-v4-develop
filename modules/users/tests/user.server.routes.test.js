...
describe('User CRUD tests', () => {
  ...
  it('should be able to update a single user details if admin', async () => {
    ...
    body.name.should.be.equal('admin_update_first');
  ...
  it('forgot password should be able to reset password for user Nouveau mot de passe plateforme LoopStyle request using username', async () => {
    user.roles = ['user'];
  ...
  it('forgot password should be able to reset password for user Nouveau mot de passe plateforme LoopStyle request using email', async () => {
    user.roles = ['user'];
