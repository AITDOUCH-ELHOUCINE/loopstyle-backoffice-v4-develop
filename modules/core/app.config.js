...
module.exports = (config) => {
  ...
  return {
    ...
    session: {
      ...
      cookie: {
        maxAge: env.get('COOKIE_MAX_AGE'),
        // expires:new Date(Date.now() + env.get('COOKIE_MAX_AGE')),
        httpOnly: env.get('COOKIE_HTTP_ONLY'),
        secure: env.get('COOKIE_SECURE'),
      },
